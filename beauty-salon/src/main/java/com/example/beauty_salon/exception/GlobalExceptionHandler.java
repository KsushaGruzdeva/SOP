...
import demo.com.beauty_salon_api.exception.TimeSlotNotAvailableException;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<StatusResponse> handleTimeSlotNotAvailable(TimeSlotNotAvailableException ex) {
        return ResponseEntity
